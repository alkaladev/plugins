...
async function getHelpMenu({ client, guild }) {
    ...
    const embed = EmbedUtils.embed()
        ...
        .setDescription(
            "**Sobre mi:**\n" +
                `Hola soy yo ${guild.members.me.displayName}!\n` +
                "Un genial bot de Discord multipropósito creado por Jorge que puede satisfacer todas tus necesidades.\n\n" +
                `**Invitame:** [Here](${client.getInvite()})\n` +
                `**Servidor de soporte:** [Join](${config["SUPPORT_SERVER"]})`,
        );
